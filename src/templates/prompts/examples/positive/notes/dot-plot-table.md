Highlights:
- Seeded randomness synchronizes the story setup (name, subject) with axis ranges and dot counts, yielding deterministic but varied instances.
- Dot plot data generation enforces at least one dot and captures per-tick counts directly for both the widget and table.
